...
Identifier<drawCircle> LPA<0> Number<20> Comma<0> Number<20> Comma<0> Number<6> RPA<0> StEnd<0> 
Identifier<drawCircle> LPA<0> Number<20> Comma<0> Number<20> Comma<0> Number<2> RPA<0> StEnd<0> 
Identifier<drawCircle> LPA<0> Number<40> Comma<0> Number<10> Comma<0> Number<3> RPA<0> StEnd<0> 
Identifier<drawCircle> LPA<0> Number<30> Comma<0> Number<10> Comma<0> Number<8> RPA<0> StEnd<0> 
Identifier<drawCircle> LPA<0> Number<50> Comma<0> Number<10> Comma<0> Number<2> RPA<0> StEnd<0> 
Identifier<drawCircle> LPA<0> Number<50> Comma<0> Number<15> Comma<0> Number<7> RPA<0> StEnd<0> 
BEnd<0> 
...
VDecl<0> Identifier<step> Assg<0> Number<0.005> StEnd<0> 
VDecl<0> Identifier<symbol> Assg<0> Number<46> StEnd<0> 
